...
> **Interview Question:** "Everyone throws around the terms Dependency Injection and Dependency Inversion. Are they the same thing? And why is injecting dependencies better than just instantiating them directly with the 'new' keyword?"
