...
> **Interview Question:** In Java, an enum is actually a special kind of class, not just a list of constants. What does that mean practically  -  can an enum have constructors, fields, and methods? And what is the "enum Singleton" idiom you mentioned earlier as a fix for thread safety?
