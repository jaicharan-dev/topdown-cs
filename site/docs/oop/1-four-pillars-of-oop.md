...
title: "Four pillars of OOP  -  abstraction vs encapsulation"
sidebar_position: 1
...
> **Interview Question:** What are the four pillars of OOP? And more specifically  -  what's the actual difference between abstraction and encapsulation? Most people can recite both definitions but can't actually distinguish them when pushed, so I want to hear how you separate the two.
