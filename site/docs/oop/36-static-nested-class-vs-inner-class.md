...
> **Interview Question:** "Walk me through the difference between a static nested class and a non-static inner class. In a production environment, why is choosing the wrong one a massive memory leak risk?"
