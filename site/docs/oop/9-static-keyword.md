...
> **Interview Question:** "What does the 'static' keyword actually mean, and how does a static method differ from an instance method? Also, can you override a static method?"
