...
title: "== vs .equals() and the equals()/hashCode() Contract"
sidebar_position: 22
...
> **Interview Question:** What is the difference between == and .equals() in Java? And what is the contract between equals() and hashCode()?
