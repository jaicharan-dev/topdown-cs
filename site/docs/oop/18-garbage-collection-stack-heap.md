...
> **Interview Question:** "Walk me through how Garbage Collection works in Java. How does the JVM decide which objects are ready to be destroyed, and how do the Stack and Heap play into this process?"
