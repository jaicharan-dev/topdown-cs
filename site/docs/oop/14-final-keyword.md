...
> **Interview Question:** What does the `final` keyword do in Java? It can be applied in three different places  -  walk me through all three and what each one does.
