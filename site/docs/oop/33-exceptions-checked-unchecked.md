...
> **Interview Question:** "How do you distinguish between checked and unchecked exceptions? More importantly, how do you decide which one to throw when designing a resilient backend system?"
