...
> **Interview Question:** "Both aggregation and composition represent a 'has-a' relationship, but they aren't the same thing. How do you define the exact boundary between the two, particularly in terms of object lifecycles?"
