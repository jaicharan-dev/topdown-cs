---
id: interface-vs-abstract-class-java8
title: "Interface vs Abstract Class: Constructors, Multiple Inheritance, Default Methods"
sidebar_position: 9
...
> **Interview Question:** What is the difference between an interface and an abstract class when it comes to constructors, multiple inheritance, and default methods in Java 8+?
