---
id: upcasting-downcasting-instanceof
...
> **Interview Question:** What are upcasting and downcasting in Java? How does the `instanceof` operator relate to them, and when would you use them in a real application?
